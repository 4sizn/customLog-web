type RootOption = { hello: Option } & { bye: Option } & {
	time: boolean;
} & Option &
...
const customLog = {
	...
	init: (options?: RootOption) => {
		...
		window.console = {
			...window.console,
			log: message(customLog.monkeyConsole.log)(options?.log),
			info: message(customLog.monkeyConsole.info)(options?.info),
			warn: message(customLog.monkeyConsole.warn)(options?.warn || {}),
		};

		message(customLog.monpeyConsole.log)(options?.hello)();
	},

	end: () => {
		// message(customLog.monkeyConsole.log)(options?.end)();
